...
namespace Homework_22.Pages
{
    public class ProductsPage : BasePage
    {
        ...
        [AllureStep("Проверка того, что страница с продуктами открылась")]
        ...
        [AllureStep("Добавление в корзину продукта: {0}")]
        ...
        [AllureStep("Проверка количества товаров в корзине")]
